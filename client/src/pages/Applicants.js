            ...
            <div key={app.user._id} className="applicant-card">
              ...
              {app.status === "pending" && (
                <div className="applicant-actions">
                  <button className="btn-accept" onClick={() => updateStatus(app.user._id, "accepted")}>Accept</button>
                  <button className="btn-reject" onClick={() => updateStatus(app.user._id, "rejected")}>Reject</button>
                </div>
              )}
            </div>
          ))}
